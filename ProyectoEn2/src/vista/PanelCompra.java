...
public class PanelCompra extends JPanel {
	    ...
	    public PanelCompra() {
	        ...
	        labelValorCripto.setFont(new Font("Arial", Font.BOLD, 14));
	        ...
	        labelStock.setFont(new Font("Arial", Font.BOLD, 14));
	...
	public float getCantidadFiat() throws NumberFormatException {
	    try {
